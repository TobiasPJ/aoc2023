...
part1 :: IO ()
part1 = do
  contents <- readFile "/Users/tobiaspetterssonjensen/Desktop/git/aoc2023/day1/input.txt"
...
getNums :: [String] -> [Int]
getNums = map getTwoDigNumsFromString
...
extractNums [] = []
extractNums (h : r)
  | isDigit h = charToInt h : extractNums r
